...
namespace IIS.Probadva
{
    ...
    public class Товары : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Probadva.ЕдИзмер fЕдиницыИзмер;
        ...
        public virtual IIS.Probadva.ЕдИзмер ЕдиницыИзмер
        {
            get
            {
                ...
                IIS.Probadva.ЕдИзмер result = this.fЕдиницыИзмер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыE", typeof(IIS.Probadva.Товары));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыL", typeof(IIS.Probadva.Товары));
                }
            }
        }
    }
