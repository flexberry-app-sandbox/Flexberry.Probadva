...
namespace IIS.Probadva
{
    ...
    public class ДокумПостав : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Probadva.Клиенты fКлиенты;
        
        private IIS.Probadva.Организация fОрганизация;
        
        private IIS.Probadva.DetailArrayOfИнфорОЗаказе fИнфорОЗаказе;
        ...
        [PropertyStorage(new string[] {
                "Клиенты"})]
        [NotNull()]
        public virtual IIS.Probadva.Клиенты Клиенты
        {
            get
            {
                ...
                IIS.Probadva.Клиенты result = this.fКлиенты;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.Probadva.Организация Организация
        {
            get
            {
                ...
                IIS.Probadva.Организация result = this.fОрганизация;
        ...
        public virtual IIS.Probadva.DetailArrayOfИнфорОЗаказе ИнфорОЗаказе
        {
            get
            {
                ...
                {
                    this.fИнфорОЗаказе = new IIS.Probadva.DetailArrayOfИнфорОЗаказе(this);
                }
                IIS.Probadva.DetailArrayOfИнфорОЗаказе result = this.fИнфорОЗаказе;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДокумПоставE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставE", typeof(IIS.Probadva.ДокумПостав));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДокумПоставL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДокумПоставL", typeof(IIS.Probadva.ДокумПостав));
                }
            }
        }
    }
